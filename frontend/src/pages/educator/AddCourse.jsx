      ...
      setChapters(
        chapters.map((chapter) => {
          if (chapter.chapterId === chapterId) {
            ...
            updatedContent.splice(lectureIndex, 1); // Remove the lecture
            return {
              ...chapter,
                ...
                <div className="p-4">
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className="flex justify-between items-center mb-2">
                      ...
                      <img src={assets.cross_icon} alt="Delete" className="cursor-pointer" onClick={() => handleLecture('remove', chapter.chapterId, lectureIndex)} />
                    </div>
                  ))}
