    ...
    <footer className="bg-gray-900 md: px-36 text-left w-full mt-10">
      ...
      <div className='flex flex-col md:items-start items-center w-full'>
        ...
        <div className='hidden md:flex flex-col items-start w-full'>
          <h2 className='font-semibold text-white mb-5'>Subscribe to our
          newsletter</h2>
          ...
          <div className='flex items-center gap-2 pt-4'>
            ...
            <button className='bg-blue-600 w-24 h-9 text-white rounded'>Subscribe</
            button>
          </div>
      ...
      {/* Copy Right Section  */}
      <p className="py-4 text-center text-xs mnd:text-sm text-white/60">Copyright 2025 @ Rohit Rathod's.  All Right Reserved. </p>
    </footer>
  );
};
